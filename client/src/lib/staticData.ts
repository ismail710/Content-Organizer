...
export const resultItems: ResultItem[] = [
  ...
  {
    id: 2,
    title: "D1.2 Internal Quality Assurance Framework",
    description: "Internal monitoring and QA protocol used by the consortium.",
    type: "deliverable",
    fileUrl: "",
    isPublic: false,
  ...
  {
    id: 3,
    title: "D2.1 Curriculum Modernization Blueprint",
    description: "Guidelines for curriculum updates and digital twin integration.",
    type: "deliverable",
    fileUrl: "/assets/deliverable2.pdf",
    isPublic: true,
    publishedAt: new Date("2026-04-08T00:00:00Z"),
  },
  {
    id: 4,
    title: "D3.1 Pilot Course Implementation Report",
    description: "Partner-level deployment report for pilot teaching activities.",
    type: "deliverable",
    fileUrl: "",
    isPublic: false,
